  ...
  public function index()
    {
        ...
        return view('mission.index2', compact('missions'));
    }
    ...
    {
        return view('mission.missv2user');
    }
      ...
      // $this->Validate($request->all());
       $mission=new mission();
        ...
        $mission->matricule= request('mat');
         ...
         $mission->save();
        return redirect()->route('missionuser.index')->with('success', 'mission Ajouté');
    }
    ...
    public function edit($id)
    {
        ...
        return view('mission.edit2', compact('missions', 'id'));
    }
    ...
    { //$this->Validate($request->all());
        ...
        $mission->anée= request('anee');
                ...
                $mission->save();
            return redirect()->route('missionuser.index')->with('success', 'mission modifié');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('missionuser.index')->with('success', 'mission supprimé');
    }
}
