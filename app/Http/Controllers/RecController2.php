...
class RecController2 extends Controller
{
    //
     /**
    ...
    { 
        ...
        return view('recommandation.index2', compact('$recommandations'));
    ...
    public function create()
    {
       // $missions = Mission::all()->toArray();
        ...
        return view('recommandation.rec2',compact('recommandations'));
        //
    }
    ...
    { $i=$request->input('note');
        ...
        $niveau_criticité=request('cr');
            ...
            return redirect()->route('recommandation2.index')->with('success', 'recommandation ajouté');
    ...
    {  
        ...
        return view('recommandation.edit2', compact('recommandations', 'id'));
        //
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('recommandation2.index')->with('success', 'recommandation modifié');
    }
    ...
    { 
        ...
        return redirect()->route('recommandation2.index')->with('success', 'recommandation supprimé');
